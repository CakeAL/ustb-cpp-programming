...
CreditAccount::CreditAccount(Date date,std::string Log_on_User, std::string id, double credit, double rate, double fee):
...
std::string CreditAccount::show() const {
    return Account::show()+"\tAvailable credit:"+std::to_string(getAvailableCredit());
